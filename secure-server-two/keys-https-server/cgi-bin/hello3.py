...
<body>
Environment Variables CONTENT_TYPE:</b> {os.getenv("CONTENT_TYPE")} HTTP_USER_AGENT:</b> {os.getenv("HTTP_USER_AGENT")} QUERY_STRING:</b> {os.getenv("QUERY_STRING")} REQUEST_METHOD:</b> {os.getenv("REQUEST_METHOD")}
